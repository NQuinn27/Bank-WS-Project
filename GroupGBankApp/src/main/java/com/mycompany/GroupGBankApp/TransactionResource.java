...
//        Double amount = o.get("amount").getAsDouble();
        ...
        Transaction transaction = new Transaction(TransactionType.LODGEMENT, o.getAccountId(), o.getCardNumber(), o.getCardCVV(), o.getCardExpiry(), o.getAmount(), o.getToAccountId());
    ...
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public Response withdrawal(String t) {
        System.out.println(t);
        GsonBuilder builder = new GsonBuilder();
        Transaction o = builder.create().fromJson(t, Transaction.class); 
//        int accountId = o.get("accountId").getAsInt();
...
//        Double amount = o.get("amount").getAsDouble();
        ...
        Transaction transaction = new Transaction(TransactionType.WITHDRAWAL, o.getAccountId(), o.getCardNumber(), o.getCardCVV(), o.getCardExpiry(), o.getAmount(), o.getToAccountId());
        System.out.println(transaction.toString());
        Transaction c = new TransactionService().createTransaction(transaction);
        transactionService.processTransaction(c.getId());
        return Response
...
//        Double amount = o.get("amount").getAsDouble();
        ...
        Transaction transaction = new Transaction(TransactionType.TRANSFER, o.getAccountId(), o.getCardNumber(), o.getCardCVV(), o.getCardExpiry(), o.getAmount(), o.getToAccountId());
        System.out.println(transaction.toString());
        Transaction c = new TransactionService().createTransaction(transaction);
        transactionService.processTransaction(c.getId());
        return Response
